            ...
            <div class="featured">
                        ...
                        <div class="entry__content">
                            ...
                            <div class="entry__info">
                                <a href="<?php echo esc_url($post_data[0]["author_url"]); ?>" class="entry__profile-pic">
                                    <img class="avatar" src="<?php echo esc_html($post_data[0]['author_avatar']) ?>" alt="<?php echo esc_attr($post_data[0]['author']); ?>">
                                </a>
                ...
                ?>
                    ...
                    <div class="entry" style="background-image:url('<?php echo esc_url($post_data[$i]['thumbnail']) ?>');">
                            ...
                            <div class="entry__content">
                                <span class="entry__category"><a href="<?php echo esc_html($post_data[0]["catlink"]) ?>"><?php echo esc_html($post_data[$i]["cat"]) ?></a></span>
