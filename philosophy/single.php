            ...
            <div class="s-content__author">
                ...
                <div class="s-content__author-about">
                    ...
                    <ul class="s-content__author-social">
                        ...
                        ?>
                            <li>
                                <a href="<?php echo esc_html($philosophy_author_facebook,"philosophy"); ?>">
                                    Facebook
                                </a>
                            </li>
                        <?php endif; ?>
                        <?php
                        if ($philosophy_author_youtube) :
                        ?>
                            <li>
                                <a href="<?php echo esc_html($philosophy_author_youtube,"philosophy"); ?>">
                                    Youtube
                                </a>
                            </li>
                        <?php endif; ?>
                        ...
                        ?>
                            <li>
                                <a href="<?php echo esc_html($philosophy_author_twitter,"philosophy"); ?>">
                                    Twitter
                                </a>
                            </li>
                        <?php endif; ?>
