  ...
  <section class="s-extra">
      ...
      <div class="row top">
                    ...
                    ?>
                      ...
                      <article class="col-block popular__post">
                          ...
                          <section class="popular__meta">
                              ...
                              <span class="popular__date"><span><?php _e("on", "philosophy"); ?></span> <time datetime="2017-12-19"><?php echo esc_html(get_the_date()); ?></time></span>
                          </section>
                      </article>
                  <?php
                    }
          ...
          <div class="col-four md-six tab-full about">
              <?php
                if (is_active_sidebar("footer-wedgets")) {
                    dynamic_sidebar("footer-wedgets");
                }
                ?>
